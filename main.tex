...
\par
The world today is highly connected by many large-scale computer networks, supporting military applications,
...
Ongoing and Future Work: We also utilized the network testbed to perform security evaluation of various smart grid applications.
...
The logically-centralized SDN control, on the one hand,
...
such as image classification and natural language processing. We want to study how to utilize the big data to secure communication networks.

The focus is to use deep-learning based approach for network intrusion detection.
Our initial approach targets on a general communication network and datasets.
