...
\begin{abstract}           % abstract environment, this is optional
    ...
    Existing evaluation platforms facilitate the adoption of the SDN architecture
    ...
    To improve the testbed scalability, we investigate how the centralized paradigm of SDN
    ...
    perform security evaluation of various SDN applications.
    ...
    For network intrusion detection, our initial approach targets on a general communication network and datasets.
