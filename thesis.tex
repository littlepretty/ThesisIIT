...
who serves as not only the biggest constant research-wise supporter, but also always the first and the gentlest challenger throughout my academic program.
As the leader of the laboratory, he and the laboratory members including Xu Yang, Xin Liu, Christopher Hannon, Ping Liu, and Xiaoliang Wu,
...
However, my biggest appreciation of course goes to my parents, Yuqing Qiao and Dengyuan Yan.
They have made sacrifice and effort beyond my imagination in order to provide me the opportunity to live and study in the United States without economic-wise worries.
Though seldom expressing it face-to-face, my love to them only get stronger deep inside my heart.
\end{acknowledgement}
...
\begin{abstract}           % abstract environment, this is optional
    ...
    \textit{For malware classification on individual host}, another necessity to secure computer system,
