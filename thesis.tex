...
\begin{abstract}           % abstract environment, this is optional
    ...
    has to process both critical control traffic and potentially big data traffic, % the inquiries from the networks (e.g., critical control and potentially big data traffic),
    ...
    \textit{For malware classification on individual host}, another necessary mechanism to secure computer system,
